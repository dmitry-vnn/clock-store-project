...
public class StandardClockDialog extends AbstractDialog<Boolean> {
    ...
    public StandardClockDialog(@NonNull Clock clock, Window owner) throws IOException {
        super(owner, "standard-clock-dialog", "Часы " + clock.mark());
    ...
    private void listenOkButton() {
        okButton.addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
            ...
            if (systemSyncCheckBox.isSelected()) {
                ...
                clock.change(hourComboBox.getValue(), minuteComboBox.getValue());
            }
